...
ncdata = nc.Dataset('Suppl_Figure5.nc')
#Read ERA5 data
...
fig.savefig('Suppl_Figure5_a-c.pdf')
...
plt.contour(lon_cmip6, lat_cmip6, domain, levels=[0.5,1,1.5], transform=crs.PlateCarree(), colors='cyan', linewidths=2, zorder=3)
ax.add_feature(cfeature.LAND, facecolor='darkgray')
ax.coastlines()
ax.set_boundary(circle, transform=ax.transAxes)
...
fig.savefig('Suppl_Figure5_d-f.pdf')
...
fig.savefig('Suppl_Figure5_g-i.pdf')